getwd()
setwd("C:/DataScienceWithR/Assignments/Graded Assignments/Topic 13 -  Final Case Study Course Wrap up")
library(dplyr)
library(caret)
library(irr)
library(VIF)
...
#you can clearly see level 7has same churn rate as the missing values 
#we can replace them with 7
